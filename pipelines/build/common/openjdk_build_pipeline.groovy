                    ...
                    try {
                        context.timeout(time: buildTimeouts.NODE_CLEAN_TIMEOUT, unit: "HOURS") {
                            if (buildConfig.TARGET_OS == "windows") {
                                ...
                                context.sh(script: "echo SXA: would like to rm -rf ${workspace}/workspace/build/src/build/*/jdk/gensrc")
                                context.sh(script: "ls -lR ${workspace}/workspace/build/src/build/*/jdk/gensrc")
